...
In case some fellows were not able to install the SignalDetectionTool package they can source the script source_signaldetectiontool.R which is commented below.
